...
LOGGING = {
    ...
    'handlers': {
        ...
        "console_error_and_critical": {
            ...
            "filters": ["require_debug_true"],
            "class": "logging.StreamHandler",
            "formatter": "Error_and_critical_console",
        },
        "general_log_file": {
            "level": "INFO",
            "filters": ["require_debug_true"],
        ...
        'mail_admins': {
            ...
            "email_backend": "django.utils.log.AdminEmailHandler",
            "formatter": "mail",
        }
    },
    'loggers': {
        'django': {
            'handlers': ['console_debug', 'console_WARNING', 'console_error_and_critical', 'general_log_file',
                         'warning_to_file'],
            'propagate': True,
        },
        'django.request': {
